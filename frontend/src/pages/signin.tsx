  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Sign in to your notes application" />
      </Head>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <div className="flex space-x-3 pt-4">
                    <button
                      type="submit"
                      disabled={loading}
                      className="flex-1 bg-orange-400 hover:bg-orange-500 text-white py-2 px-4 rounded-md font-medium transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                    >
                      {loading ? 'Logging in...' : 'Login'}
                    </button>
                    <Link
                      href="/signup"
                      className="flex-1 bg-teal-400 hover:bg-teal-500 text-white py-2 px-4 rounded-md font-medium text-center transition-colors"
                    >
                      Register
                    </Link>
                  </div>
